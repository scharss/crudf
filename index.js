...
function readTask(){
  ...
  <div class="card mb-3">
    <div class="card-body" style="background-color:#DFE3EA">
             ...
             <button type="submit" style="color:white" class="btn btn-dark" onclick="updateTask(${taskValue.id},'${taskValue.task}','${taskValue.description}')"><i class="fas fa-edit"></i> Editar Tarea</button>
